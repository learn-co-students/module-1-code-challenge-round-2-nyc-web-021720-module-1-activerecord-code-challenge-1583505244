...
s1 = Specialist.create(name: "Justin",employees_specialist: "IT")
s2 = Specialist.create(name: "Alicia",employees_specialist: "IT")
s3 = Specialist.create(name: "Melissa", employees_specialist: "IT")